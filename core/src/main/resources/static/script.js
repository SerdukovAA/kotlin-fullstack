...
if (typeof render === 'undefined') {
  throw new Error("Error loading module 'script'. Its dependency 'render' was not found. Please, check whether 'render' is loaded prior to 'script'.");
}
var script = function (_, Kotlin, $module$render) {
  'use strict';
  var Unit = Kotlin.kotlin.Unit;
  var throwCCE = Kotlin.throwCCE;
  var lib = $module$render.com.nixvision.support.terminal.render.lib;
  ...
  return _;
}(typeof script === 'undefined' ? {} : script, kotlin, render);
